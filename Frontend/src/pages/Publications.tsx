    ...
    useEffect(() => {
        ...
        if (initialFilters) {
            setFilters({
                ...
                precioMaximo: initialFilters.priceMax || 1000000
            });
        }
    }, [location.state]);
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="w-[95%] h-auto flex flex-col items-start p-4 md:p-8 bg-[#F8F6E8] rounded-[10px]">
                        ...
                        {loading ? (
                            ...
                            <div className="flex flex-col md:flex-col items-center md:items-start justify-center md:justify-start gap-3 md:gap-5 overflow-y-scroll custom-scrollbar w-full h-auto md:h-[99vh] pb-5">
