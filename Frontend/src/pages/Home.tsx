...
export const Home = () => {
    return (
        <>
            <div className="w-full h-screen bg-[#FEFCEC]">
                <Header />
                <div className="w-full h-full p-5 mt-5 flex flex-col items-center">
                    <img src={banner} alt="banner" className="w-full h-[440px] md:h-[500px] rounded-[30px] opacity-[70%]"/>
                    <h1 className="text-[#393939] text-[30px] md:text-[50px] font-bold absolute mt-[160px]">Encuentra Tu Nuevo Hogar</h1>
                    <div className="w-[50%] h-[90px] bg-[#FEFEFE] flex flex-row items-center  rounded-[30px] absolute md:mt-[450px] mt-[400px] opacity-[99%] shadow-[0_10px_10px_rgba(0,0,0,0.2)]">
