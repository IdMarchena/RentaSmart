    ...
    return (
        <div className="w-full h-[150px] flex flex-row items-center justify-between bg-[#EFEDDE] border-[1px] border-[#BCBBB0] rounded-[30px]">
            <div className="w-[70%] flex flex-col items-start justify-center p-6 gap-1">
                <h1 className="text-[#393939] text-[15px] font-bold">Total de Publicaciones</h1>
                <span className="text-[#393939] text-[30px] font-bold">10</span>
                <p className="text-[#393939] text-[9px] font-medium">Estas son las publicaciones que tienes disponibles para tus arrendatarios.</p>
            </div>
