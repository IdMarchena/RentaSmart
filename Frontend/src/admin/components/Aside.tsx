...
export const Aside = () => {
    ...
    return (
        <div className="w-auto h-full flex flex-col items-start justify-start border-r border-[#C7C6BA] gap-2 p-5 max-[1082px]:p-2">
            <div className="w-full h-[50px] bg-[#FEFCEC] flex flex-row items-center justify-center mb-2 p-2 max-[1082px]:justify-start">
            ...
            <div className="w-full h-full flex flex-col items-start justify-center gap-5 p-2">
                <div className="flex flex-row items-center justify-between w-full max-[1082px]:justify-start max-[1082px]:gap-2">
                    <Link to="/admin"><img src={isHome ? imgHomeOn : imgHomeOff} alt="Logo" className="w-[30px] h-[30px]"/></Link>
                ...
                <div className="flex flex-row items-center justify-between w-full max-[1082px]:justify-start max-[1082px]:gap-2">
                    <Link to="/admin/publications"><img src={isPublications ? imgPubliOn : imgPubliOff} alt="Logo" className="w-[30px] h-[30px]"/></Link>
                ...
                <div className="flex flex-row items-center justify-between w-full max-[1082px]:justify-start max-[1082px]:gap-2">
                    <Link to="/admin/contracts"><img src={isContracts ? imgContratosOn : imgContratosOff} alt="Logo" className="w-[30px] h-[30px]"/></Link>
                ...
                <div className="flex flex-row items-center justify-between w-full max-[1082px]:justify-start max-[1082px]:gap-2">
                    <Link to="/admin/messages"><img src={isMessages ? imgChatOn : imgChatOff} alt="Logo" className="w-[30px] h-[30px]"/></Link>
                ...
                <div className="flex flex-row items-center justify-between w-full max-[1082px]:justify-start max-[1082px]:gap-2">
                    <Link to="/admin/services"><img src={isServices ? imgServicioOn : imgServicioOff} alt="Logo" className="w-[30px] h-[30px]"/></Link>
            ...
            <div className="w-full h-full flex flex-col items-start justify-end gap-5 p-2">
                <div className="flex flex-row items-center justify-between w-full max-[1082px]:justify-start max-[1082px]:gap-2">
                    <Link to="/admin/user"><img src={isUser ? imgUserOn : imgUserOff} alt="Logo" className="w-[30px] h-[30px]"/></Link>
